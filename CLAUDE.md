...
This project is indexed by GitNexus as **frontend** (1864 symbols, 3494 relationships, 162 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
